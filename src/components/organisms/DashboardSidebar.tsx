...
export function DashboardSidebar({
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full m-2 md:mx-3 md:mb-3 rounded-3xl bg-[#0B1020] text-slate-100 border border-white/15 shadow-2xl pt-4 w-full md:w-64 shrink-0 overflow-hidden">
